...
export default function QuestionAccordion() {
  return (
    <div className="w-full max-w-3xl mx-auto py-12">
      <h2 className="text-3xl font-bold mb-8 text-center">Questions fréquemment demandé sur e-immo</h2>
      <Accordion type="single" collapsible className="space-y-4">
        <AccordionItem value="faq-1">
          <AccordionTrigger className="flex items-center justify-between w-full  dark:bg-gray-800 px-6 py-4 rounded-md font-medium">
        ...
        <AccordionItem value="faq-2">
          <AccordionTrigger className="flex items-center justify-between w-full  dark:bg-gray-800 px-6 py-4 rounded-md font-medium">
            What if I'm moving to a new city?
